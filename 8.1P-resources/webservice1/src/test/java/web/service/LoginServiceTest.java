...
public class LoginServiceTest {
    ...
    public void testLoginSuccess() {
        System.setProperty(
                ...
                "C:/chromedriver-win64 (2)/chromedriver-win64/chromedriver.exe");
        ...
        driver.navigate().to(
                "C:/Users/shevi/eclipse-workspace/8.1P-resources/pages/login.html");
        sleep(5);
        ...
        ele.clear();
        ele.sendKeys("shevin_pass");

        // Find date of birth element
        ele = driver.findElement(By.id("dob"));
        ele.clear();
        ele.sendKeys("1999-09-22"); // Updated date of birth
    ...
    public void testInvalidDateFormat() {
        ...
        ele = driver.findElement(By.id("dob"));
        ele.clear();
        ele.sendKeys("09/22/1999"); // Invalid date format
